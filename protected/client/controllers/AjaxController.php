...
class AjaxController extends Controller {
        ...
        public function actionSelectSubCaste() {
                ...
                if(!empty($model)) {
                        $options = "<option value=''>Select Sub-Community</option>";
                        foreach($model as $subcaste) {
                                $options .= '<option value="' . $subcaste->id . '">' . $subcaste->sub_caste . '</option>';
                        }
                } else {
                        $options = '<option value="">Select Sub-Community</option><option value="0">Other</option>';
                }
                echo $options;
        }
        ...
        public function actionSelectCity() {
                ...
                if(!empty($model)) {
                        ...
                        $options = '<option value="">Select City</option><option value="0">Other</option>';
                }
                echo $options;
        }
