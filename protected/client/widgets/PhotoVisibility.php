...
class PhotoVisibility extends CWidget {
        ...
        public function run() {
                ...
                $this->render('photovisibility', array('user' => $user, 'partner' => $partner, 'intrest_send' => $intrest_send, 'intrest_accept' => $intrest_accept, 'width' => $this->width, 'height' => $this->height));
        }
