        ...
        <div class="col-sm-12 <?php echo $this->type; ?>_tagss">
            
        </div>
         <div class="col-sm-10 <?php echo $this->type; ?>_reciverr">
                <?php if($this->field_val!=''){
    ...
    if(event.keyCode == 13) {
      ...
      return false;
        ...
        $('.<?php echo $this->type; ?>_need_add').live('click',function(){
                var val=$(this).attr('id');
                $.ajax({
                'url': baseurl + 'rfpRfq/<?php echo $this->type; ?>TagAdd',
                'async': false,
                'type': "POST",
                'global': false,
                'dataType': 'html',
       ...
       /* $('#category_tag_select').live('click',function(){
        ...
        $('#<?php echo $this->type; ?>_tag_select').live('keyup',function(event){
        ...
        $( ".<?php echo $this->type; ?>_tag-sub" ).live('click',function(){
         ...
         $( ".<?php echo $this->type; ?>_closee" ).live('click',function(){
...
function <?php echo $this->type; ?>SelectTag(val){
        ...
        $.ajax({
        'url': baseurl + 'rfpRfq/<?php echo $this->type; ?>Tag',
        'async': false,
        'type': "POST",
        'global': false,
        'dataType': 'html',
        'data':{tag : val,type : '<?php echo $this->type; ?>',taged:cat},
                success: function(result) {
                        ...
                        $('.<?php echo $this->type; ?>_tagss').show();
                            ...
                            $('.<?php echo $this->type; ?>_tagss').html('<div class="<?php echo $this->type; ?>_need_add" id="'+val+'">This tag is not in our database. Click to add " '+val+' " to Category Tags ?</div>');
                            $('.<?php echo $this->type; ?>_tagss').show();
                        }
                }
