                ...
                <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8 search">
                                <div class="row">
                                        ...
                                        <div class=row>
                                                ...
                                                <div class="col-xs-3 col-md-2 col-sm-2">
                                                        <div class="form-group">
                                                                ...
                                                                <form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Matches/TwoWayMatchesList" id="search_form_shortlist" method="post">
                                                                        <?php
                                                ...
                                                <div class="col-xs-1 col-md-1 col-sm-1 nop">
                                                        <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Matches/TwoWayMatchesList"><img class="center-block grids" src="<?php echo Yii::app()->request->baseUrl; ?>/images/g2.jpg"></a>
                                                </div>
                                                <div class="col-xs-1 col-md-1 col-sm-1 nop">
                                                        <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Matches/TwoWayMatches"><img class="center-block ans grids" src="<?php echo Yii::app()->request->baseUrl; ?>/images/g3.jpg"></a>
                                                </div>
                                        ...
                                        <?php
                                        $this->widget("application.client.widgets.TwoWayMatches", array('id' => Yii::app()->session['user']['id'], 'sort' => $sort, 'view' => 2));
                                        ?>
