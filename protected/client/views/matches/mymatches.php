                ...
                <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8 search">
                                <div class="row">
                                        ...
                                        <div class=row>
                                                ...
                                                <div class="col-xs-3 col-md-2 col-sm-2">
                                                        <div class="form-group">
                                                                ...
                                                                <form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Matches/MyMatches" id="search_form_shortlist" method="post">
                                                                        <?php
                                        ...
                                        <?php
                                        $this->widget("application.client.widgets.Matches", array('id' => Yii::app()->session['user']['id'], 'sort' => $sort, 'view' => 1));
                                        ?>
