    ...
    <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div style="margin:auto; width:776px; border:solid 2px #404241; margin-top:40px; margin-bottom:40px;">
            <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                    <td><a href="http://laksyah.com"><img src="<?= Yii::app()->baseUrl; ?>/images/emailer_01.jpg" width="776" height="102" alt=""></a></td>
                </tr>
                <tr>
                    <td style="padding:40px 20px; font-family:'Open Sans',arial, sans-serif; font-size:13px"><p style="font-size:14px; font-weight:bold;">Interest Received,</p>
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;">You have received an interest from <?= $model->first_name . ' ' . $model->last_name ?>, To accept the intersest .
                            <?php echo CHtml::link('Click Here', 'myaccount/Pending', array('target' => '_blank')); ?>
                        </p>
