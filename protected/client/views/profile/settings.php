                                                ...
                                                <div class="common">
                                                        ...
                                                        <?php } else { ?>
                                                                <div class="col-sm-12 zeros">
                                                                        ...
                                                                        <span class="vis"> <input type="radio" class="radios" name="photo_visibility" value="2" > Visible Only on Invitation Sent/Accepted<a href="#" data-toggle="tooltip" data-placement="top" title="Visible only after request sent/accepted!"><img class="ques" src="<?php echo Yii::app()->request->baseUrl; ?>/images/question.jpg"></a></span>
                                                                </div>
                                                        <?php } ?>
                                                        <?php if ($model->photo_visibility == 3) { ?>
                                                                <div class="col-sm-12 zeros">

                                                                        <span class="vis"> <input type="radio" class="radios" name="photo_visibility" id="photo_visibility" value="3" checked> Password Protected<a href="#" data-toggle="tooltip" data-placement="top" title="Password protected!"><img class="ques" src="<?php echo Yii::app()->request->baseUrl; ?>/images/question.jpg"></a>
                                                                        </span>
                                                        ...
                                                        <?php } else { ?>
                                                                <div class="col-sm-12 zeros">
                                                                        ...
                                                                        <span class="vis"> <input type="radio" class="radios" name="photo_visibility" value="3" > Password Protected<a href="#" data-toggle="tooltip" data-placement="top" title="Password protected!"><img class="ques" src="<?php echo Yii::app()->request->baseUrl; ?>/images/question.jpg"></a></span>
                                                                </div>
                                                        <?php } ?>
