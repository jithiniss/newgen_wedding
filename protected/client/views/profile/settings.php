                ...
                <div class="row">
                        ...
                        <div class="col-md-9 details">
                                ...
                                <ul id="myTabs" class="nav nav-tabs nav-justified adv">
                                        ...
                                        <li class="sims active"><?php echo CHtml::link('Settings', array('Profile/MySettings')); ?></li>
                                </ul>
                                ...
                                <div class="outs-2">
                                        ...
                                        <form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Profile/MySettings" method="post">
                                                <div class="common">
