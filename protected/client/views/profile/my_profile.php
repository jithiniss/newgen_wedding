                    ...
                    <div class="zeros">
                        ...
                        <div class="strip">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><?php echo CHtml::link('Set Contact Filters', array('/contact-filters')); ?></li>
                                ...
                                <div class="col-md-6 lifestyle">
                                    ...
                                    <div class="copyz">
                                        ...
                                        <div class="col-sm-6 col-xs-8 zeros">
                                            <label for="textinput" class="control-labelz">
                                                <?php
                                                if ($myProfile->num_of_unmarried_brother != 0) {
                                                        echo $myProfile->num_of_unmarried_brother . ' of which un married,';
                                                } else {
                                                        echo '';
                                                }
                                                if ($myProfile->num_of_married_brother != 0) {
                                                        echo $myProfile->num_of_married_brother . ' of which married ';
                                                } else {
                                                        echo '';
                                                }
                                    ...
                                    <div class="copyz">
                                        ...
                                        <div class="col-sm-6 col-xs-8 zeros">
                                            <label for="textinput" class="control-labelz">
                                                <?php
                                                if ($myProfile->num_of_unmarried_sister != 0) {
                                                        echo $myProfile->num_of_unmarried_sister . ' of which un married,';
                                                } else {
                                                        echo '';
                                                }
                                                if ($myProfile->num_of_married_sister != 0) {
                                                        echo $myProfile->num_of_married_sister . ' of which married ';
                                                } else {
                                                        echo '';
                                                }
