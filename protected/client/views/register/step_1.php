                                ...
                                <div class="col-md-8 col-sm-12 col-xs-12 prime">
                                        ...
                                        <div class="zeros">
                                                ...
                                                <div class="common">
                                                        ...
                                                        <div class="col-sm-8 col-xs-8 zeros">
                                                                <div class="form-group">
                                                                        <?php echo CHtml::activeDropDownList($firstStep, 'country', CHtml::listData(MasterCountry::model()->findAllByAttributes(array('status' => 1)), 'id', 'country'), array('empty' => '--SPlease elect Country--', 'class' => 'aps', 'options' => array('id' => array('selected' => 'selected')))); ?>
                                                ...
                                                <div class="common tops">
                                                        ...
                                                        <div class="col-sm-4 col-xs-4 zeros">
                                                                ...
                                                                <button  type="submit" id="firststep" onclick="test()" class="btn sub-btn btn-default">Submit</button>
                                                        </div>
                                                </div>
