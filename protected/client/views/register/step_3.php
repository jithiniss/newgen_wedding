        ...
        <div class="row">
            <div class="col-md-12 ">
                ...
                <ul id="myTabf" class="nav nav-tabs ppl nav-justified ">
                    <li class="sim"><a href="register-1.php">Primary Info</a></li>
                    <li class="sim"><a href="register-2.php">Location & Background</a> </li>
                    <li class="sim active"><a href="register-3.php">Lifestyle & Appearance </a> </li>
                    <li class="sim"><a href="register-4.php">Education & Career</a> </li>
                </ul>

                <form action="action_page.php">

                    <h5>Your lifestyle details will help us find the best matches for you...
                    </h5>
