                        ...
                        <div class="col-md-12">
                                ...
                                <div class="new_form">
                                        ...
                                        <?php } else { ?>
                                                ...
                                                <form role="form" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/couple/forgotpassword" method="post">
                                                        <div class="form-group">

                                                                <input type="email" class="form-new" id="email" placeholder="Couple Email" name="email">
                                                        </div>
