                        ...
                        <div class="panel panel-primary">
                                <div class="panel-heading">
                                        ...
                                        <div class="btn-group pull-right">
                                                <span class="chat_close"><?php echo CHtml::link('X', array('site/index')); ?></span>
                                                                                ...
                                                                                <div class="chat-body clearfix">
                                                                                        <div class="header">
                                                                                                <strong class="primary-font"><?php echo $user_details->first_name . ' ' . $user_details->last_name; ?> </strong> <small class="pull-right text-muted">
                                                                                                        <span class="glyphicon"></span><input class="datetime_<?php echo $chat->id; ?>" type="hidden" value="<?php echo $chat->date; ?>" /><span id="timeago"><?php echo $this->time_elapsed_string($chat->date); ?></span></small>
                                                                                        </div>
                                                                                        <p>
                                                                                                <?php if ($chat->feild1 == '') { ?>
                                ...
                                <div class="panel-footer">
                                        <div class="input-group chat-footer">
                                                ...
                                                <form method="post" enctype="multipart/form-data"  id="chat-form">
                                                        ...
                                                        <input style="display: none;" type="file" name="ChatBox[feild1]" id="file-6" class="inputfile inputfile-5 chat_pics"/>


                                                </form>
                                                <input style="height: 48px;" id="btn-input" required="" type="text" autocomplete="off" class="form-control input-sm chat-area" name="chat-message" placeholder="Type your message here..." />
