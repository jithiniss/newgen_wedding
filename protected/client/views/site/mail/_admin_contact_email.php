        ...
        <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                ...
                <div style="margin:auto; width:776px; border:solid 2px #404241; margin-top:40px; margin-bottom:40px;">
                        <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center">
                                ...
                                <tr>
                                        <td style="padding:40px 20px; font-family:'Open Sans',arial, sans-serif; font-size:13px"><p style="font-size:14px; font-weight:bold;">Enquiry Details</p>
                                                <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;"><br><br>
                                                        Name:<?php echo $model->name; ?><br><br>
                                                        Email Id:<?php echo $model->email; ?><br><br>
                                                        Mobile:<?php echo $model->mobile; ?><br><br>
                                                        Subject:<?php echo $model->subject; ?><br><br>
                                                        Message:<?php echo $model->message; ?><br><br>
