                                    ...
                                    <div class="nop">
                                        <ul class="nav navbar-nav">
                                            ...
                                            if(isset(Yii::app()->session['user']['id']) && Yii::app()->session['user']['id'] != '') {
                                                    ?>
                                                    <li class="colors"><?php echo CHtml::link('<i class="fa locks fa-user"></i>Hi,' . Yii::app()->session['user']['first_name'], array('Myaccount/Index')); ?></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer-about col col-xs-6 col-sm-4 col-md-2">
                        ...
                        <ul>
                            <li><a href="<?= Yii::app()->baseUrl ?>/index.php/site/about">About Us</a></li>
