                                                                ...
                                                                <div id="cssmenu">
                                                                        <ul>
                                                                                ...
                                                                                if (isset(Yii::app()->session['user']) && Yii::app()->session['user'] != '') {
                                                                                        if (Yii::app()->session['user']['register_step'] == 4 || Yii::app()->session['user']['register_step'] == 5) {
                                                                                                ?>
                                                                                                <li><?php echo CHtml::link('<i class="fa locks fa-user"></i>Hi, ' . Yii::app()->session['user']['first_name'], array('Myaccount/Index')); ?></li>
                                                                                                <?php
                                                                                        } else {
                                                                                                ?>
                                                                                                <li><a ><i class="fa locks fa-user"></i>Hi, <?php echo Yii::app()->session['user']['first_name']; ?></a></li>
                                                                                                <?php
                                                                                        }
                                                                                        ?>
                                                                                        <li><?php echo CHtml::link('<i class="fa locks fa-lock"></i>Log Out', array('site/logout')); ?></li>
                                                                                <?php } else if (isset(Yii::app()->session['vendor']) && Yii::app()->session['vendor'] != '') { ?>
                                                                                        <li><?php echo CHtml::link('<i class="fa locks fa-user"></i>Hi, ' . Yii::app()->session['vendor']['first_name'], array('vendor/index')); ?></li>
                                                                                        <li><?php echo CHtml::link('<i class="fa locks fa-lock"></i>Log Out', array('vendor/logout')); ?></li>
                                                                                        <?php
                                                                                } else {
                                                                                        ?>
                                                                                        <li> <?php echo CHtml::link('<i class="fa locks fa-lock"></i>Vendor', array('vendor/index')); ?></li>
                                                                                        <li> <?php echo CHtml::link('<i class="fa locks fa-lock"></i>Login', array('site/login')); ?></li>
                                                                                        <li> <?php echo CHtml::link('<i class="fa locks fa-user-plus"></i>Register', array('register/FirstStep')); ?></li>
                                                                                <?php } ?>
                                                                        </ul>
                                                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="footer-about col col-xs-6 col-sm-4 col-md-2">
                                                ...
                                                <ul>
                                                        ...
                                                        <li><?php echo CHtml::link('Event Management', array('weddingPlanner/index')); ?></li>
                                                        <li><?php echo CHtml::link('Plans', array('site/index', '#' => 'upgrade')); ?></li>
                                                        <li><?php echo CHtml::link('Contact Us', array('site/contact')); ?></li>
                                                </ul>
