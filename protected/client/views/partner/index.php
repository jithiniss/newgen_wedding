...
//                                                $block_details = BlockedMembers::model()->findByAttributes(array('block_id' => $mat->id, 'user_id' => Yii::app()->session['user']['id'], 'status' => 0));
                                                        ...
                                                        <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                        <div class="modal-body">
                                                                                <?php $album = UserPhotos::model()->findAllByAttributes(array('user_id' => $user_details->id, 'approval' => '1', 'status' => '1')); ?>

                                                                                <ol class="carousel-indicators">
                                                                                        <?php for ($i = 0; $i < sizeof($album); $i++) { ?>
                                                                                                <li data-target="#lightbox" data-slide-to="<?php echo $i; ?>" <?php if ($i == 0) { ?>class="active"<?php } ?>></li>
                                                                                        <?php } ?>
                                                                                ...
                                                                                <th style="border-right:0;">
                                                                                        ...
                                                                                        if ($user_details->photo != '') {
                                                                                                ...
                                                                                                <?php if ($user_details->gender == 1) { ?>
                                                                                                        ...
                                                                                                        <?php }if ($user_details->photo_visibility == 2) { ?>
                                                                                        <div class="profile mynewgenz newgen_visibility ">
                                                                                                <img class="him side" src="<?php echo Yii::app()->request->baseUrl; ?>/images/gen.jpg">
                                                                                                <img class="img_lock" src="<?php echo Yii::app()->request->baseUrl; ?>/images/lock.png">
                                                                                                <!--<p>Visible on Accept/Sent</p>-->
                                                                                        </div>
                                                                                <?php }if ($user_details->photo_visibility == 3) { ?>
                                                                                        <div class="profile mynewgenz newgen_visibility">
                        ...
                        <?php } else { ?>
                                <div class="accesdenied">
                                        <div class="col-xs-6 row-borderd text-right empty_image"><img class="logo_error" src="<?php echo Yii::app()->baseUrl ?>/images/logo.png" alt=""/></div>
                                        <div class="col-xs-6 empty_message">
                                                <h2 class="fournotfour">Access Denied</h2>
                                                <h3>Looks like the Profile Access is Restricted. Sorry about that.</h3>
                                        </div>
                                </div>
                        <?php } ?>
