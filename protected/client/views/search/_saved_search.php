...
<div class="right-box">
        <form class="form-inline"  role="form" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Search/SearchById/id/<?php echo $this->encrypt_decrypt('encrypt', $id); ?>" id="search_form" method="POST">
