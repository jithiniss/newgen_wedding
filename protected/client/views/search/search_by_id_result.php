        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 search">
                <div class="row">
                    ...
                    <?php
                    $this->widget("application.client.widgets.SearchById", array('id' => $id, 'sort' => $sort, 'view' => 1, 'photo' => $photo, 'joined' => $joined, 'active_mem' => $active_mem, 'marital_stat' => $marital_stat, 'profile_crea' => $profile_crea, 'smoking' => $smoking, 'drinking' => $drinking, 'diets' => $diets));
                    ?>
