        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 search-result">
                <div class="">
                    ...
                    <?php
                    $this->widget("application.client.widgets.AdvanceSearch", array('id' => $id, 'sort' => $sort, 'view' => 2, 'photo' => $photo, 'joined' => $joined, 'active_mem' => $active_mem, 'marital_stat' => $marital_stat, 'profile_crea' => $profile_crea, 'smoking' => $smoking, 'drinking' => $drinking, 'diets' => $diets));
                    ?>
                </div>
            </div>
        </div>
