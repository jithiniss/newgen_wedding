                                        ...
                                        <div class="strip">
                                                ...
                                                <div class="strip-padding">
                                                        ...
                                                        <?php foreach ($details as $detail) { ?>
                                                                ...
                                                                <a href="<?php echo yii::app()->baseUrl . '/index.php/user/delete/id/' . $detail->id; ?>"><img style="width: 25px;" alt="delete" class="delete_photo" src="<?php echo yii::app()->baseUrl; ?>/images/delete-trash.jpg"></a>
                                                                <?php
