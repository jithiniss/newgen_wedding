            ...
            <div class="col-md-9">
                <div class="send">
                    ...
                    <div class="ui-send">
                        ...
                        <div class="send-six">
                            <ul class="list-inline list-unstyled">
                                <li><img class="sends" src="<?= Yii::app()->baseUrl; ?>/images/h1.png"></li>
                                <li><div class="ten">+7</div></li>
                                <li><a href="#" class="connect-8">Add Photo</a></li>
                            </ul>
                        </div>
                    </div>
                    <h4>Requests</h4>
                    ...
                    foreach ($requests as $requsts) {
                            ...
                            <div class="ui-send">
                                <div class="send-left">
                                    <img class="sends" src="images/h1.png">
                                </div>
