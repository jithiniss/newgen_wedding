                                ...
                                <div class="messagez">
                                        <form method="post" id="photo_update" enctype="multipart/form-data" action="<?= Yii::app()->baseUrl; ?>/index.php/Myaccount/UpdatePhoto" >
                                                ...
                                                <ul class="list-unstyled">
                                                        <li><a href="#" id="my-button"><img class="access" src="<?php echo yii::app()->request->baseUrl; ?>/images/ab1.png">Add Photos</a></li>
                                                        <li><a href="#"><img class="access" src="<?php echo yii::app()->request->baseUrl; ?>/images/ab2.png">Edit Profile</a></li>
                                                        <li><a href="#"><img class="access" src="<?php echo yii::app()->request->baseUrl; ?>/images/ab3.png">Settings</a></li>
                                                </ul>
                                        </form>
                                </div>
                        </div>
