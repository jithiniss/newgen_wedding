                ...
                <div class="messagez">
                    <form method="post" id="photo_update" enctype="multipart/form-data" action="<?= Yii::app()->baseUrl; ?>/index.php/Myaccount/UpdatePhoto" >
                        ...
                        <ul class="list-unstyled">
                            <li> <?php echo CHtml::link('<img class="access" src="' . Yii::app()->request->baseUrl . '/images/ab1.png">Add Photos', array('Profile/MyPhotos')); ?></li>
                            <li> <?php echo CHtml::link('<img class="access" src="' . Yii::app()->request->baseUrl . '/images/ab2.png">My Profile', array('profile/MyProfile')); ?></li>
                            <li> <?php echo CHtml::link('<img class="access" src="' . Yii::app()->request->baseUrl . '/images/ab3.png">Settings', array('settings/index')); ?></li>
