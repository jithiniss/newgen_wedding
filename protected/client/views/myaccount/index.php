                ...
                <div class="row">
                        ...
                        <div class="col-md-9 mynewgenz nop strongz">
                                ...
                                <div class="badgez">
                                        ...
                                        <div class="trust">
                                                <?php
                                                if ($user->mob_num_verification == '1') {
                                                        ?>
                                        ...
                                        <div class="trust">
                                                <?php
                                                $facebook = Facebook::model()->findByAttributes(array('user_id' => $user->id));
//                                                if ($user->oauth_uid != '') {
                                                if ($facebook->verify_status == '1') {
                                                        ?>
                                                        <i class = "fa circles fa-check-circle-o"></i>
                                                <?php }
                                                ?>
                                        ...
                                        <div class="trust">
                                                <?php
                                                $document = Documents::model()->findByAttributes(array('user_id' => $user->id));
                                                ...
                                                <div class="rel-1">
                                                        <h2>Your current plan -
                                                                ...
                                                                if ($my_plan->status != 0) {
                                                                        ...
                                                                        $plans_id = UserDetails::model()->findByPk(Yii::app()->session['user']['id']);
                                                                        echo Plans::model()->findByPk($plans_id->plan_id)->plan_name;
                                                                }
                                                                ?> </h2>
