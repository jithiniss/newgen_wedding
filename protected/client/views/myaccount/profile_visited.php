                                        ...
                                        <div class=row>
                                                ...
                                                <div class="col-xs-3 col-md-2 col-sm-2">
                                                        <div class="form-group">
                                                                ...
                                                                <form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Myaccount/ProfileVisited" id="search_form_shortlist" method="post">
                                                                        <?php
                                                ...
                                                <div class="col-xs-1 col-md-1 col-sm-1 nop">
                                                        <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Myaccount/ListProfileVisited"><img class="center-block grids" src="<?php echo Yii::app()->request->baseUrl; ?>/images/g2.jpg"></a>
                                                </div>
                                                <div class="col-xs-1 col-md-1 col-sm-1 nop">
