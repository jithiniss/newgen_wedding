...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
        ...
        public function actionIndex() {
                $dataProvider = new CActiveDataProvider('MasterCountry');
        ...
        public function loadModel($id) {
                $model = MasterCountry::model()->findByPk($id);
                if ($model === null)
         ...
         * @param MasterCountry $model the model to be validated
         */
        protected function performAjaxValidation($model) {
                if (isset($_POST['ajax']) && $_POST['ajax'] === 'master-country-form') {
