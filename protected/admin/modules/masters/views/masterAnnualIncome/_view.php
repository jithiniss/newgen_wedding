...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('income_from')); ?>:</b>
	<?php echo CHtml::encode($data->income_from); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('income_to')); ?>:</b>
	<?php echo CHtml::encode($data->income_to); ?>
	<br />
