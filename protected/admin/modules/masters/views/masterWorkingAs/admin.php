...
<div class="page-title">
        ...
        <div class="title-env">
                ...
                <p style="float: left;margin-top: 8px;margin-left: 11px;" class="description">Manage Master Working As</p>
        </div>
        ...
        <div class="breadcrumb-env">
                ...
                <ol class="breadcrumb bc-1" >
                        ...
                        <li class="active">
                                ...
                                <strong>Manage Master Working As</strong>
                        </li>
                </ol>
...
<div class="row">
        ...
        <div class="col-sm-12">
                ...
                <a class="btn btn-secondary btn-icon btn-icon-standalone" href="<?php echo Yii::app()->request->baseurl . '/admin.php/masters/masterWorkingAs/create'; ?>" id="add-note">
                        <i class="fa-pencil"></i>
                        <span>Add Master Working As</span>
                </a>
