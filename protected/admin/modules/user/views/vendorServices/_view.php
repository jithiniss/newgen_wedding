...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('phn_no')); ?>:</b>
	<?php echo CHtml::encode($data->phn_no); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('linkdin')); ?>:</b>
	<?php echo CHtml::encode($data->linkdin); ?>
	<br />
