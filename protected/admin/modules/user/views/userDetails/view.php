...
<div class="col-sm-12">
        <a class="btn btn-secondary btn-icon btn-icon-standalone" href="<?php echo Yii::app()->request->baseurl . '/admin.php/user/userDetails/admin'; ?>" id="add-note">
                <i class="fa-pencil"></i>
...
//        'dob_year',
        ...
        array(
            ...
            'filter' => array('1' => 'Yes', '2' => 'No', '3' => 'Dont No'),
            'value' => function($data) {
            if ($data->suddha_jadhagam == 1) {
                    $result = 'Yes';
            } else if ($data->suddha_jadhagam == 2) {
                    $result = 'No';
            } else if ($data->suddha_jadhagam == 3) {
                    $result = 'Dont No';
            } else {
                    $result = '--';
            }
...
//        'regional_site',
        ...
        array(
            'name' => 'disablity',
            'filter' => array('1' => 'No', '2' => 'Physically Disabled'),
            'value' => function($data) {
            return $data->disablity == 2 ? 'Physically Disabled' : 'No';
    }
        ),
        array(
            'name' => 'smoke',
            'filter' => array('1' => 'No', '2' => 'Yes', '3' => 'Occasionally'),
            'value' => function($data) {
            if ($data->smoke == 1) {
                    $result = 'No';
            } else if ($data->smoke == 2) {
                    $result = 'Yes';
            } else if ($data->smoke == 3) {
                    $result = 'Occasionally';
            } else {
                    $result = '--';
            }
