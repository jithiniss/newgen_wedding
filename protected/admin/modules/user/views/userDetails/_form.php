...
<div class="form">
        ...
        <div class="form-inline">
                ...
                <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($model, 'suddha_jadhagam', array('1' => 'Yes', '2' => 'No', '3' => 'Dont No'), array('empty' => '--Select--', 'class' => 'form-control')); ?>
                ...
                <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($model, 'disablity', array('1' => 'No', '2' => 'Physically Disabled'), array('class' => 'form-control')); ?>
                        <?php echo $form->error($model, 'disablity'); ?>
                </div>
                <br/>
                <div class="form-group" style="width: 12.5%;">
                        <?php echo $form->labelEx($model, 'smoke'); ?>
                        <?php echo $form->dropDownList($model, 'smoke', array('1' => 'No', '2' => 'Yes', '3' => 'Occasionally'), array('class' => 'form-control')); ?>
                        <?php echo $form->error($model, 'smoke'); ?>
                </div>

                <div class="form-group" style="width: 12.5%; margin-left: 0px;">
                        <?php echo $form->labelEx($model, 'drink'); ?>
                        <?php echo $form->dropDownList($model, 'drink', array('1' => 'No', '2' => 'Yes', '3' => 'Occasionally'), array('class' => 'form-control')); ?>
