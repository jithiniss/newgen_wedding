                        ...
                        <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center">
                                ...
                                <tr>
                                        <td style="padding:40px 20px; font-family:'Open Sans',arial, sans-serif; font-size:13px">
                                                <p style="font-size:14px; font-weight:bold;"><?php echo $newsletter->heading; ?></p>


                                                <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;"><?php echo $newsletter->subheading; ?></p>
                                                ...
                                                <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;font-weight:bold;"><img width="125" style="border: 2px solid #d2d2d2;" src="<?php echo $this->siteURL(); ?>/uploads/newsletter/<?php echo $newsletter->id; ?>.<?php echo $newsletter->image ?>" /></p>
