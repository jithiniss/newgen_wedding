...
<div class="page-title">
    ...
    <div class="title-env">
        <h1 style="float: left;" class="title">Document Verification</h1>
        <p style="float: left;margin-top: 8px;margin-left: 11px;" class="description">Document Verification</p>
    </div>
...
//                    'ub',
                    ...
                    array(
                        ...
                        'buttons' => array
                            ...
                            'verified' => array
                                (
                                'url' => 'Yii::app()->createUrl("/documents/notVerify", array("id"=>$data->id))',
                            ...
                            'Not verified' => array
                                (
                                'url' => 'Yii::app()->createUrl("/documents/verify", array("id"=>$data->id))',
